  ...
  <div className="w-full bg-white overflow-x-auto scrollbar-hide">
    <div className="flex items-center min-w-max md:min-w-full">
        ...
        if (isActive) {
            ...
            textClass = "text-[12px] font-bold uppercase tracking-tight text-[#001433]";
            iconClass = "w-6 h-6 md:w-5 md:h-5 rounded-full flex items-center justify-center text-[10px] bg-[#001433] text-white border border-[#001433] flex-shrink-0";
        } else if (isCompleted) {
        ...
        return (
            ...
            >
                {/* Active Bottom Bar */}
                {isActive && <div className="absolute bottom-0 left-0 w-full h-[3px] bg-[#001433]"></div>}
