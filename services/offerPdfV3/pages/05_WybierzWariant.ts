...
<div class="page-body" style="padding-top:18px;padding-bottom:62px;display:flex;flex-direction:column">
    <p class="lead" style="margin-bottom:6px">Dwa warianty — jeden cel: <strong>maksymalne oszczędności przy zerowym ryzyku prawnym</strong>. Rekomendujemy <strong>Eliton Prime™ PLUS</strong> — oto konkretne rezultaty, które osiągasz.</p>

    <table class="vt" style="font-size:11px;margin-bottom:8px">
      <thead>
        <tr>
          <th></th>
      ...
      <tbody>
        ...
        <tr><td>Asekuracja prawna bez angażowania Zarządu<span class="sub">Pełna reprezentacja przez Stratton Prime przy ZUS, PIP i KAS</span></td><td class="hl yes">✓ pełna ochrona</td><td class="yes">✓ pełna ochrona</td></tr>
    ...
    <div class="box-navy" style="padding:14px 18px;margin-bottom:6px;flex:1;display:flex;flex-direction:column;justify-content:space-between">
      <div style="font-size:9px;font-weight:600;letter-spacing:.15em;text-transform:uppercase;color:var(--sp-gold-light);margin-bottom:10px">W wariancie PLUS — Polisa D&amp;O Leadenhall LW020/D&amp;O/01</div>
      <div style="display:grid;grid-template-columns:1fr 1fr;gap:16px;flex:1;align-items:center">
        <div>
          <p style="font-size:12px;color:rgba(255,255,255,.75);line-height:1.65;margin-bottom:10px">Chroni: członków zarządu, rady nadzorczej, prokurentów, głównych księgowych oraz ich małżonków i spadkobierców. Klauzule A+B obligatoryjne (A = odpowiedzialność osobista Zarządu, B = refundacja przez spółkę).</p>
          <p style="font-size:10.5px;color:rgba(255,255,255,.42);line-height:1.6">Ochrona retroaktywna · Trigger claims made<br>3 lata (obecni D&amp;O) / 10 lat (byli D&amp;O)</p>
        </div>
        <div style="border-left:1px solid rgba(255,255,255,.1);padding-left:20px">
          <div style="font-size:10px;color:rgba(255,255,255,.4);margin-bottom:6px;letter-spacing:.08em;text-transform:uppercase">Suma gwarancyjna</div>
          <div style="font-family:var(--font-serif);font-size:28px;color:var(--sp-gold-light);line-height:1;margin-bottom:8px">500 tys.–30 mln zł</div>
          <div style="font-size:11px;color:rgba(255,255,255,.45);line-height:1.6">W pakiecie · bez dopłat<br>Dopasowywana indywidualnie</div>
        </div>
      </div>
    </div>

    <div class="box-gold" style="padding:7px 12px;margin-bottom:5px">
      ...
      <p style="font-size:10.5px;color:var(--sp-text-muted);line-height:1.5">Klienci Eliton Prime™ mogą nabyć certyfikowaną opinię Kancelarii Radców Prawnych i Doradców Podatkowych <strong>Żuk Pośpiech Sp. k.</strong> (Katowice) — obejmującą pełną analizę wdrożenia dla Twojej Spółki: ZUS (§2 ust. 1 pkt 26), PIT, KUP CIT (art. 15 ust. 1 uCIT). <span style="font-size:9.5px;color:var(--sp-text-muted)">Zamówienia: biuro@stratton-prime.pl</span></p>
    </div>
