    ...
    return (
        <div className={`animate-in fade-in zoom-in-95 ${animations.slow} h-full flex flex-col gap-3 md:gap-4 w-full overflow-hidden`}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 flex-shrink-0">
                ...
                <div className="col-span-1 md:col-span-2 bg-[#001433] rounded-md px-4 py-3 md:px-7 md:py-5 flex flex-col justify-between relative overflow-hidden shadow-[0_6.4px_14.4px_0_rgba(0,0,0,0.13),0_1.2px_3.6px_0_rgba(0,0,0,0.10)] group">
                    ...
                    <div className="relative z-10 flex items-center gap-2 md:gap-4">
                        ...
                        <div>
                            <div className="flex items-baseline gap-2">
                                ...
                                <span className="hidden md:inline text-[10px] text-[#a19f9d] uppercase tracking-wide">Business Solutions</span>
                            </div>
                            ...
                            <p className="hidden md:block text-[#a19f9d] mt-1 text-xs md:text-sm max-w-xl">
                    ...
                    <div className="relative z-10 mt-2 md:mt-4">
                        <button 
                            ...
                            className="bg-white text-[#201f1e] hover:bg-blue-50 px-3 py-2 md:px-5 md:py-2.5 rounded-md font-bold flex items-center gap-1.5 md:gap-2.5 transition-all shadow-[0_1.6px_3.6px_0_rgba(0,0,0,0.13)] hover:shadow-[0_3.2px_7.2px_0_rgba(0,0,0,0.13)] hover:-translate-y-0.5 group/btn text-xs md:text-sm"
                        >
                            <div className="p-1 bg-[#001433] rounded-full text-white group-hover/btn:scale-110 transition-transform">
                ...
                >
                    <div>
                        <div className="flex items-center justify-between mb-2 md:mb-3">
                            <span className="text-[10px] font-bold text-[#a19f9d] uppercase tracking-wider">Status Sesji</span>
                            ...
                            {hasActiveSession ? (
                                ...
                                <div className="w-1.5 h-1.5 rounded-full bg-[#c8c6c4]"></div>
                            )}
                        </div>
                        ...
                        {hasActiveSession ? (
                            <div className="space-y-2.5">
                                <div>
                                    <div className="text-xl font-bold text-[#201f1e]">{pracownicy.length}</div>
                                    <div className="text-[11px] text-[#605e5c]">Wczytanych pracowników</div>
                                </div>
                                {firma.nazwa && (
                                    <div className={`px-3 py-2 rounded-sm border transition-colors flex items-center justify-between ${isSessionSaved ? 'bg-blue-50 border-blue-100' : 'bg-[#f3f2f1] border-[#edebe9]'}`}>
                                        <div className="flex items-center gap-2 text-[#323130] font-semibold text-xs truncate">
                                            <Building className={`w-3.5 h-3.5 flex-shrink-0 ${isSessionSaved ? 'text-blue-400' : 'text-[#a19f9d]'}`} />
                                            {firma.nazwa}
                                        </div>
                            ...
                            <div className="flex flex-col items-center justify-center h-20 text-[#c8c6c4]">
            ...
            <div className="bg-white rounded-md border border-[#edebe9] shadow-[0_1.6px_3.6px_0_rgba(0,0,0,0.13),0_0.3px_0.9px_0_rgba(0,0,0,0.11)] flex flex-col flex-1 min-h-0 overflow-hidden">
                <div className="flex items-center gap-2.5 px-5 py-3.5 border-b border-[#edebe9] flex-shrink-0">
                    <Clock className="text-[#a19f9d] w-4 h-4" />
                    <h3 className="text-sm font-bold text-[#201f1e]">Ostatnia Aktywność</h3>
                </div>
