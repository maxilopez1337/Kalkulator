...
export const generateFullHistoryExcel = async ({
  firma,
  pracownicy,
  wyniki,
  prowizjaProc,
  ...
  const applySegmentedHeaders = (
    ws: ExcelWorksheet,
    styleType: 'arkusz1' | 'podsumowanie' | 'segmented' = 'segmented'
  ) => {
    const headerRow = ws.getRow(1);
    headerRow.height = 50;
    headerRow.eachCell((cell: ExcelCell, colNumber: number) => {
  ...
  wsPracownicy.columns = [
    ...
    {
      header: 'Koszty uzyskania przychodu',
      key: 'kup',
      width: 25,
      style: { numFmt: styles.currencyPlain },
    },
    {
      header: 'Kwota zmniejszająca podatek',
      key: 'pit2',
      width: 25,
      style: { numFmt: styles.currencyPlain },
    },
  ...
  pracownicy.forEach((p) => {
    wsPracownicy.addRow({
      ...
      podatek: p.ulgaMlodych
        ? 'Ulga dla młodych (0)'
        : p.pitMode === 'AUTO' || (p.pitMode as string) === 'ZASADY_OGOLNE'
          ? 'Zasady ogólne (12%)'
          : p.pitMode,
    });
  });
  ...
  const stdColumns = [
    ...
    {
      header: 'Łączna wartość wynagrodzenia netto',
      key: 'netto',
      width: 15,
      style: { numFmt: styles.currencyPlain },
    },
    {
      header: 'Łączna wartość brutto na umowie',
      key: 'brutto',
      width: 15,
      style: { numFmt: styles.currencyPlain },
    },
    {
      header: 'Łączny koszt pracodawcy (BRUTTO BRUTTO)',
      key: 'kosztPracodawcy',
      width: 20,
      style: { numFmt: styles.currencyPlain },
    },
    {
      header: 'Podstawa do naliczenia składek ZUS',
      key: 'podstZus',
      width: 15,
      style: { numFmt: styles.currencyPlain },
    },
    {
      header: 'Składki Emerytalne',
      key: 'ePracownik',
      width: 15,
      style: { numFmt: styles.currencyPlain },
    },
    {
      header: 'Składki Rentowe',
      key: 'rPracownik',
      width: 15,
      style: { numFmt: styles.currencyPlain },
    },
    {
      header: 'Składki Chorobowe',
      key: 'cPracownik',
      width: 15,
      style: { numFmt: styles.currencyPlain },
    },
    {
      header: 'Składki społeczne pracownika',
      key: 'spolecznePrac',
      width: 15,
      style: { numFmt: styles.currencyPlain },
    },
    {
      header: 'Podstawa wymiaru składki zdrowotnej',
      key: 'podstZdrowotna',
      width: 15,
      style: { numFmt: styles.currencyPlain },
    },
    {
      header: 'Składka zdrowotna',
      key: 'zdrowotna',
      width: 15,
      style: { numFmt: styles.currencyPlain },
    },
    {
      header: 'Podstawa opodatkowania',
      key: 'podstPit',
      width: 15,
      style: { numFmt: styles.currencyPlain },
    },
    ...
    {
      header: 'Emerytalna [pracodawcy]',
      key: 'ePracodawca',
      width: 15,
      style: { numFmt: styles.currencyPlain },
    },
    {
      header: 'Rentowa [pracodawcy]',
      key: 'rPracodawca',
      width: 15,
      style: { numFmt: styles.currencyPlain },
    },
    {
      header: 'Wypadkowa [pracodawcy]',
      key: 'wPracodawca',
      width: 15,
      style: { numFmt: styles.currencyPlain },
    },
    ...
    {
      header: 'Suma składek ZUS pracodawcy',
      key: 'zusPracodawcaSuma',
      width: 15,
      style: { numFmt: styles.currencyPlain },
    },
    {
      header: 'Łączna SUMA składek pracownika i pracodawcy',
      key: 'zusRazem',
      width: 20,
      style: { numFmt: styles.currencyPlain },
    },
  ...
  stdSumRow.eachCell((c: ExcelCell) => {
  ...
  const podzColumns = [
    ...
    {
      header: 'Wynagrodzenie w formie pieniężnej netto',
      key: 'pieniezneNetto',
      width: 15,
      style: { numFmt: styles.currencyPlain },
    },
    {
      header: 'Brutto od netto',
      key: 'zasadniczeBrutto',
      width: 15,
      style: { numFmt: styles.currencyPlain },
    },
    {
      header: 'Dodatek STRATTON netto',
      key: 'strattonNetto',
      width: 15,
      style: { numFmt: styles.currencyPlain },
    },
    {
      header: 'Dodatek STRATTON brutto',
      key: 'strattonBrutto',
      width: 15,
      style: { numFmt: styles.currencyPlain },
    },
    {
      header: 'Zaliczka od świadczenia netto',
      key: 'pomocnicza',
      width: 15,
      style: { numFmt: styles.currencyPlain },
    },
    ...
    {
      header: 'Zaliczka na podatek (PIT) od kwoty brutto',
      key: 'pitZaliczka',
      width: 15,
      style: { numFmt: styles.currencyPlain },
    },
    {
      header: 'DO WYPŁATY wynagrodzenie w formie pieniężnej',
      key: 'doWyplKasa',
      width: 15,
      style: { numFmt: styles.currencyPlain },
    },
    {
      header: 'DO WYPŁATY przychód STRATTON',
      key: 'doWyplStratton',
      width: 15,
      style: { numFmt: styles.currencyPlain },
    },
    {
      header: 'DO WYPŁATY suma świadczeń',
      key: 'doWyplSuma',
      width: 15,
      style: { numFmt: styles.currencyPlain },
    },
    ...
    {
      header: 'Suma składek ZUS pracownika',
      key: 'zusPracSuma',
      width: 15,
      style: { numFmt: styles.currencyPlain },
    },
    ...
    {
      header: 'Potrącenie STRATTON',
      key: 'potracenieStratton',
      width: 15,
      style: { numFmt: styles.currencyPlain },
    },
  ...
  wyniki.szczegoly.forEach((w) => {
    ...
    const rowValues = [
      ...
      isStudent ? s.pit : p.pit.kwota,
      isStudent ? 0 : 1.0, // Potrącenie STRATTON
    ...
    for (let i = 2; i < rowValues.length; i++) {
      if (i !== 24 && typeof rowValues[i] === 'number') {
        // 24 = stawkaPit (0-based)
  ...
  podzSumRow.eachCell((c: ExcelCell) => {
    c.fill = styles.sumsRowFill;
    c.font = styles.sumsRowFont;
  });
  ...
  const compColumns = [
    ...
    {
      header: 'Łączna wartość brutto na Ustawie',
      key: 'laczneBrutto',
      width: 15,
      style: { numFmt: styles.currencyPlain },
    },
    {
      header: 'Zaliczka na podatek dochodowy od kwoty brutto',
      key: 'pitZaliczka',
      width: 15,
      style: { numFmt: styles.currencyPlain },
    },
    {
      header: 'DO WYPŁATY wynagrodzenie w formnie pieniężnej',
      key: 'doWyplGotowka',
      width: 15,
      style: { numFmt: styles.currencyPlain },
    },
    ...
    },
    {
      ...
      key: 'doWyplSuma',
      width: 15,
      style: { numFmt: styles.currencyPlain, font: { bold: true } },
    },
    {
      header: 'Łączny koszt wynagrodzenia (BRUTTO BRUTTO)',
      key: 'koszt',
      width: 15,
      style: { numFmt: styles.currencyPlain, font: { bold: true } },
    },
    {
      header: 'Podstawa do naliczenia składek',
      key: 'podstZus',
      width: 15,
      style: { numFmt: styles.currencyPlain },
    },
    ...
    {
      header: 'Suma składek pracownika',
      key: 'zusPracownikSuma',
      width: 15,
      style: { numFmt: styles.currencyPlain },
    },
    {
    ...
    { header: 'FGŚP', key: 'fgspPracodawca', width: 15, style: { numFmt: styles.currencyPlain } },
    {
      header: 'Suma składek pracodawcy',
      key: 'zusPracodawcaSuma',
      width: 15,
      style: { numFmt: styles.currencyPlain },
    },
    {
      header: 'Łączna SUMA składek ZUS Pracownik i Pracodawca',
      key: 'zusSumaCalkowita',
      width: 15,
      style: { numFmt: styles.currencyPlain },
    },
  ];
  ...
  wyniki.szczegoly.forEach((w) => {
    ...
    const pracownikString = w.pracownik.imie
      ? w.pracownik.imie + ' ' + w.pracownik.nazwisko
      : 'Pracownik ' + w.pracownik.id;
    const etatZlecenie = w.pracownik.typUmowy === 'UOP' ? 'Etat' : 'Zlecenie';
    ...
    const pPotracenieStratton = isStudent ? 0 : 1.0;
    ...
    const pEPrac = isStudent
      ? std.zusPracownik.emerytalna
      : podz.zasadnicza.zusPracownik.emerytalna;
    ...
    const pEPracodawca = isStudent
      ? std.zusPracodawca.emerytalna
      : podz.zasadnicza.zusPracodawca.emerytalna;
    const pRPracodawca = isStudent
      ? std.zusPracodawca.rentowa
      : podz.zasadnicza.zusPracodawca.rentowa;
    const pWPracodawca = isStudent
      ? std.zusPracodawca.wypadkowa
      : podz.zasadnicza.zusPracodawca.wypadkowa;
    ...
    const pZusPracodawcaSuma = isStudent
      ? std.zusPracodawca.suma
      : podz.zasadnicza.zusPracodawca.suma;
  ...
  wsPodsumowanie.columns = [
    ...
    {
      header: 'OBECNIE (STANDARD)',
      key: 'standard',
      width: 25,
      style: { numFmt: styles.currencyPlain },
    },
    {
      header: activeModel === 'PRIME' ? 'Eliton Prime™ PLUS' : 'Eliton Prime™',
      key: 'eliton',
      width: 35,
      style: { numFmt: styles.currencyPlain },
    },
  ...
  wsPodsumowanie.addRow([
    '* Szczegółowe zestawienie i różnice dla poszczególnych pracowników znajdują się w arkuszu "4. Porównanie Szczegółowe".',
  ]);
  ...
  const strBrutto = wyniki.szczegoly.reduce(
    (acc, w) =>
      acc +
      (w.pracownik.trybSkladek === 'STUDENT_UZ' ? w.standard.brutto : w.podzial.pit.lacznyPrzychod),
    0
  );

  const stdZusPracodawca = wyniki.szczegoly.reduce(
    (acc, w) => acc + w.standard.zusPracodawca.suma,
    0
  );
  const strZusPracodawca = wyniki.szczegoly.reduce(
    (acc, w) =>
      acc +
      (w.pracownik.trybSkladek === 'STUDENT_UZ'
        ? w.standard.zusPracodawca.suma
        : w.podzial.zasadnicza.zusPracodawca.suma),
    0
  );

  const stdZusPracown = wyniki.szczegoly.reduce(
    (acc, w) => acc + w.standard.zusPracownik.suma + w.standard.zdrowotna,
    0
  );
  const strZusPracown = wyniki.szczegoly.reduce(
    (acc, w) =>
      acc +
      (w.pracownik.trybSkladek === 'STUDENT_UZ'
        ? w.standard.zusPracownik.suma
        : w.podzial.zasadnicza.zusPracownik.suma + w.podzial.zasadnicza.zdrowotna),
    0
  );

  const stdNetto = wyniki.szczegoly.reduce((acc, w) => acc + w.standard.netto, 0);
  const strNetto = wyniki.szczegoly.reduce(
    (acc, w) =>
      acc + (w.pracownik.trybSkladek === 'STUDENT_UZ' ? w.standard.netto : w.podzial.doWyplaty),
    0
  );
  ...
  workbook.worksheets.forEach((worksheet) => {
    worksheet.columns.forEach((column: ExcelColumn) => {
      let maxLength = 0;
