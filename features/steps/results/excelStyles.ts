...
export const applyHeaderStyle = (row: any) => {
...
export const groupStyles = {
    ...
    blue: {
        ...
        border: { top: { style: 'thin', color: { argb: 'FFBFDBFE' } }, left: { style: 'thin', color: { argb: 'FFBFDBFE' } }, right: { style: 'thin', color: { argb: 'FFBFDBFE' } }, bottom: { style: 'thin', color: { argb: 'FFBFDBFE' } } }
    },
    indigo: {
...
export const applyTotalStyle = (row: any) => {
...
export const applyDataStyle = (row: any) => {
