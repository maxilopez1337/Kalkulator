...
import { STANDARD_TABLE_CONFIG, SPLIT_TABLE_CONFIG } from '../../../../features/steps/results/excelTableConfigs';
...
export const generateFullHistoryExcel = async ({ firma, pracownicy, wyniki, prowizjaProc, activeModel }: GeneratorOptions) => {
    ...
    const adminAmount = activeModel === 'PRIME' ? baseBenefitNetto * 0.02 : 0;
